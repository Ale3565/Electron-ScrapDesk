...
import ComponenteA1 from './ComponenteA1';
import ComponenteA2 from './ComponenteA2';
import ComponenteA3 from './ComponenteA3';
...
function App() {
  ...
  const renderMainContent = () => {
    switch (activeSection) {
      case 'home':
        return <ComponenteA setActiveSection={setActiveSection} />;
      case 'acm':
        return <ComponenteA1 />;
      case 'finanzas':
        return <ComponenteA2 />;
